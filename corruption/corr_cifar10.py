...
def motion_blur(x, severity=1):
    ...
    output = BytesIO()
    x = Image.fromarray(x.astype(np.uint8)) # added by cy: from numpy to PIL
...
def frost(x, severity=1):
    ...
    filename = ['./core/corruptions/frost1.png', './core/corruptions/frost2.png', './core/corruptions/frost3.png', './core/corruptions/frost4.jpg', './core/corruptions/frost5.jpg', './frost6.jpg'][idx]
...
def jpeg_compression(x, severity=1):
    ...
    x = np.asarray(x) # added by cy: to numpy
